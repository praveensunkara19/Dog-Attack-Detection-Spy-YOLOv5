...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        if ("dog" in s) and ("dog biting child" in s):
        ...
        if ("child" in s) and ("dog biting child" in s):
            pygame.mixer.init()  # Initialize the mixer
            pygame.mixer.music.load("data/images/audio.mp3")  # Load the sound file
            pygame.mixer.music.play()  # Play the sound
            send_notification()
        ...
        if ("running child" in s) and ("dog biting child" in s):
            pygame.mixer.init()  # Initialize the mixer
            pygame.mixer.music.load("data/images/audio.mp3")  # Load the sound file
            pygame.mixer.music.play()  # Play the sound
            send_notification()
        ...
        if ("chasing dog" in s) and ("dog biting child" in s):
            pygame.mixer.init()  # Initialize the mixer
            pygame.mixer.music.load("data/images/audio.mp3")  # Load the sound file
            pygame.mixer.music.play()  # Play the sound
            send_notification()
        ...
        if ("chasing dog" in s) and ("running child" in s):
            pygame.mixer.init()  # Initialize the mixer
            pygame.mixer.music.load("data/images/audio.mp3")  # Load the sound file
            pygame.mixer.music.play()  # Play the sound
            send_notification()
        ...
        if ("child" in s) and ("chasing dog" in s):
            pygame.mixer.init()  # Initialize the mixer
            pygame.mixer.music.load("data/images/audio.mp3")  # Load the sound file
            pygame.mixer.music.play()  # Play the sound
            send_notification()
